...
transProgram x = case x of
  Bnfc.Abs.Program _ stmts -> failure x
...
transStmt x = case x of
  ...
  Bnfc.Abs.Decl _ type_ ident expr -> failure x
  Bnfc.Abs.Ass _ ident expr -> failure x
  Bnfc.Abs.Incr _ ident -> failure x
  Bnfc.Abs.Decr _ ident -> failure x
  ...
  Bnfc.Abs.Print _ expr -> failure x

transArg :: Show a => Bnfc.Abs.Arg' a -> Result
transArg x = case x of
  Bnfc.Abs.ValArg _ type_ ident -> failure x
  Bnfc.Abs.RefArg _ type_ ident -> failure x
...
transExpr x = case x of
  Bnfc.Abs.EVar _ ident -> failure x
